...
import 'package:helloworld/ProductDetail.dart';
...
class ListProductsAPI extends StatefulWidget {
  ...
  @override
  ListProductStateAPI createState() => ListProductStateAPI();
}

//------------------------------------
//
class ListProductStateAPI extends State<ListProductsAPI> {
            ...
            child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Card(
                    ...
                    elevation: 15.0, // Hiệu ứng đổ bóng cho sản phẩm
                    child: Column(
                      children: [
                        //Vung cua anh
                        //
